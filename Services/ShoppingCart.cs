...
namespace Sapias.Commerce.Services {
    public class ShoppingCart : IShoppingCart {
        ...
        private const string _shoppingCartSessionKey = "ShoppingCart";
        ...
        private List<ShoppingCartItem> ItemsInternal {
            get {
                var items = (List<ShoppingCartItem>)HttpContext.Session[_shoppingCartSessionKey];

                if (items == null) {
                    items = new List<ShoppingCartItem>();
                    HttpContext.Session[_shoppingCartSessionKey] = items;
                }
        ...
        public decimal Vat() {
            return Subtotal() * .19m; // TODO: configurable
        }
